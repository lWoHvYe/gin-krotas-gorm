...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.Status = field.NewString(tableName, "status")
...
func (a userRoleBelongsToUser) Unscoped() *userRoleBelongsToUser {
	a.db = a.db.Unscoped()
	return &a
}
...
func (a userRoleBelongsToUserTx) Unscoped() *userRoleBelongsToUserTx {
	a.tx = a.tx.Unscoped()
	return &a
}
...
func (a userRoleBelongsToRole) Unscoped() *userRoleBelongsToRole {
	a.db = a.db.Unscoped()
	return &a
}
...
func (a userRoleBelongsToRoleTx) Unscoped() *userRoleBelongsToRoleTx {
	a.tx = a.tx.Unscoped()
	return &a
}
