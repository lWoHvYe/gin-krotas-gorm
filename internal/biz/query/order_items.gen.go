...
func newOrderItem(db *gorm.DB, opts ...gen.DOOption) orderItem {
	...
	_orderItem.OrderSn = field.NewString(tableName, "order_sn")
	_orderItem.SpuID = field.NewInt64(tableName, "spu_id")
	_orderItem.SkuID = field.NewInt64(tableName, "sku_id")
	_orderItem.SkuName = field.NewString(tableName, "sku_name")
	_orderItem.SkuPic = field.NewString(tableName, "sku_pic")
	_orderItem.Price = field.NewFloat64(tableName, "price")
	_orderItem.Num = field.NewInt32(tableName, "num")
...
type orderItem struct {
	...
	SpuID     field.Int64   // 商品SPU_ID
	SkuID     field.Int64   // 商品SKU_ID
	SkuName   field.String  // 商品名称
	SkuPic    field.String  // 商品图片
	Price     field.Float64 // 下单时价格
...
func (o *orderItem) updateTableName(table string) *orderItem {
	...
	o.SpuID = field.NewInt64(table, "spu_id")
